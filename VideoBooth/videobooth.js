...
function pushUnpushButtons(idToPush, idArrayToUnpush) {
	if (idToPush != "") {
		...
		if (!(theClass.indexOf("selected") >= 0)) {//check if already selected/pressed this button
			theClass = theClass + " selected";//if not, add "selected" class, make the button looked pressed
